...
**Private preview.17 — SDK folder picker fix:** Browse SDK folder now works when Setup & Paths is embedded in the main window. Tuning calculations and FFB read/apply behavior are unchanged from preview.16.
