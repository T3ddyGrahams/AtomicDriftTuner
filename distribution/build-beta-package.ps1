...
foreach ($guide in @("GUIDED_WORKFLOW.md", "TOUCHSCREEN.md", "GEARING.md", "TELEMETRY_INTELLIGENCE.md", "TRACK_TOOLS.md", "PIT_SETUP.md", "PITHOUSE.md", "CAR_PHYSICS.md", "PACKED_FORMAT_SOURCES.md")) {
...
foreach ($name in @("ADTCompanion.lua", "companion_client.lua", "setup_capture.lua", "pit_setup.lua", "track_position.lua", "manifest.ini", "icon.png")) {
