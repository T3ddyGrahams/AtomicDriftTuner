...
**Current test round: v0.9.0-preview.30.** Start with the [release checklist](testing/v0.9.0-preview.30-checklist.md), then use this guide for detailed instructions. See the [compatibility tracker](testing/v0.9.0-preview.30-compatibility.md) for coverage gaps and reviewed results. Include checklist case IDs and outcomes in your report; successful tests and skipped cases are useful too.
