# Start-to-finish tuning — local preview.14

Local 0.9.0-preview.14 starts with your own hardware/car choices and asks what you want to tune. It keeps the existing tuning intelligence, sustained-angle goals, run history, touchscreen and gearing support, and adds optional current-setup capture through the updated in-game companion. It is a local test build; the public release remains preview.3.
