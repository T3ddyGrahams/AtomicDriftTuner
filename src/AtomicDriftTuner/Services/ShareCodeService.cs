...
public sealed class ShareCodeService
{
        ...
        CarBehaviorTarget behavior)
    {
        ...
        var payload = new AtomicSharePayload
        {
            Schema = Schema,
            ...
            Input = new AtomicShareInput
            {
                ...
                Car = new AtomicShareCar
                {
                    ...
                    SourceFolderName = CleanOptional(
            ...
            Recommendation = new AtomicShareRecommendation
            {
                Azom = new AtomicShareAzomRecommendation
                {
                    WheelRotationAngleDeg =
                        result.Azom.Core.WheelRotationAngleDeg,

                    GameFfbStrengthPct =
                        result.Azom.Core.GameFfbStrengthPct,

                    BaseTorqueOutputPct =
                        result.Azom.Core.BaseTorqueOutputPct,

                    MaximumWheelSpeedPct =
                        result.Azom.Core.MaximumWheelSpeedPct,

                    Interpolation =
                        result.Azom.Core.Interpolation,

                    WheelDamperPct =
                        result.Azom.WheelbaseEffects.WheelDamperPct,

                    WheelFrictionPct =
                        result.Azom.WheelbaseEffects.WheelFrictionPct,

                    NaturalInertia =
                        result.Azom.WheelbaseEffects.NaturalInertia,

                    HighSpeedDampingPct =
                        result.Azom.HighSpeedDamping.DampingLevelPct,

                    HighSpeedTriggerKph =
                        result.Azom.HighSpeedDamping.TriggerSpeedKph,

                    EqHz10 =
                        result.Azom.FfbEqualizer.Hz10,

                    EqHz15 =
                        result.Azom.FfbEqualizer.Hz15,

                    EqHz25 =
                        result.Azom.FfbEqualizer.Hz25,

                    EqHz40 =
                        result.Azom.FfbEqualizer.Hz40,

                    EqHz60 =
                        result.Azom.FfbEqualizer.Hz60,

                    EqHz100 =
                        result.Azom.FfbEqualizer.Hz100,

                    EqSensitivity =
                        result.Azom.FfbEqualizer.Sensitivity,

                    OutputCurvePreset =
                        result.Azom.FfbOutputCurve.Preset,

                    CurveNode20 =
                        result.Azom.FfbOutputCurve.Node20,

                    CurveNode40 =
                        result.Azom.FfbOutputCurve.Node40,

                    CurveNode60 =
                        result.Azom.FfbOutputCurve.Node60,

                    CurveNode80 =
                        result.Azom.FfbOutputCurve.Node80,

                    CurveNode100 =
                        result.Azom.FfbOutputCurve.Node100
                },
        ...
        AtomicSharePayload payload)
    {
        ...
        {
            throw new InvalidDataException(
                "Compressed share payload is too large.");
        }

        var code =
            Prefix +
            ToBase64Url(compressed);
    ...
    public AtomicSharePayload Decode(
        string code)
    {
        ...
        {
            throw new InvalidDataException(
                $"ADT Share Codes must start with {Prefix}");
        }
        ...
        {
            throw new InvalidDataException(
                "The share code contains no payload.");
        }
        ...
        {
            throw new InvalidDataException(
                "The share code contains invalid Base64URL data.",
                ex);
        }
        ...
        {
            throw new InvalidDataException(
                "The share code contains no compressed payload.");
        }

        if (compressed.Length > MaxCompressedBytes)
        {
            throw new InvalidDataException(
                "The share code exceeds the supported compressed size.");
        }
        ...
        try
        {
            ...
            while (true)
            {
                ...
                {
                    throw new InvalidDataException(
                        "Decoded share payload exceeds the supported size.");
                }
        ...
        {
            throw new InvalidDataException(
                "The share code could not be decompressed.",
                ex);
        }
        ...
        {
            throw new InvalidDataException(
                "The share code decoded to an empty payload.");
        }
        ...
        {
            payload =
                JsonSerializer.Deserialize<AtomicSharePayload>(
                    json,
                    _json)
                ?? throw new InvalidDataException(
                    "The share code contains no payload.");
        ...
        {
            throw new InvalidDataException(
                "The share code contains invalid JSON.",
                ex);
        }
        ...
        AtomicSharePayload payload)
    {
        ...
        return new TuneInput
        {
            Hardware = new HardwareProfile
            {
                Id =
                    Clean(
                        payload.Input.Hardware.Id,
                        120),

                Manufacturer =
                    Clean(
                        payload.Input.Hardware.Manufacturer,
                        80),

                Model =
                    Clean(
                        payload.Input.Hardware.Model,
                        120),
                ...
                MaxRotationDeg =
                    payload.Input.Hardware.MaxRotationDeg,

                IsCustom =
                    payload.Input.Hardware.IsCustom
            },
            ...
            Wheel = new SteeringWheelProfile
            {
                Id =
                    Clean(
                        payload.Input.Wheel.Id,
                        120),

                Manufacturer =
                    Clean(
                        payload.Input.Wheel.Manufacturer,
                        80),

                Model =
                    Clean(
                        payload.Input.Wheel.Model,
                        120),

                DiameterMm =
                    payload.Input.Wheel.DiameterMm,

                InertiaFactor =
                    payload.Input.Wheel.InertiaFactor,

                IsRound =
                    payload.Input.Wheel.IsRound,

                IsCustom =
                    payload.Input.Wheel.IsCustom
            },
            ...
            DriftPack = new DriftPackProfile
            {
                ...
                Name =
                    Clean(
                        payload.Input.Pack.Name,
                        160),

                Category =
                    Clean(
                        payload.Input.Pack.Category,
                        80),

                GripBias =
                    payload.Input.Pack.GripBias,

                SelfSteerBias =
                    payload.Input.Pack.SelfSteerBias,

                DampingBias =
                    payload.Input.Pack.DampingBias,

                DetailBias =
                    payload.Input.Pack.DetailBias,

                IsCustom =
                    payload.Input.Pack.IsCustom
            },
            ...
            Car = new CarProfile
            {
                ...
                DisplayName =
                    Clean(
                        payload.Input.Car.DisplayName,
                        180),

                MassKg =
                    payload.Input.Car.MassKg,

                PowerHp =
                    payload.Input.Car.PowerHp,

                TorqueNm =
                    payload.Input.Car.TorqueNm,

                Drivetrain =
                    Clean(
                        payload.Input.Car.Drivetrain,
                        20),

                SteeringLockPerSideDeg =
                    payload.Input.Car.SteeringLockPerSideDeg,

                CasterDeg =
                    payload.Input.Car.CasterDeg,

                FrontTireWidthMm =
                    payload.Input.Car.FrontTireWidthMm,

                RearTireWidthMm =
                    payload.Input.Car.RearTireWidthMm,

                Grip =
                    payload.Input.Car.Grip,
                ...
                SourceFolderName =
                    CleanOptional(
                        payload.Input.Car.SourceFolderName,
                        120),
                ...
                DataSourceSummary =
                    "Imported ADT Share Code; local path/data is not embedded.",
            ...
            {
                Kind =
                    payload.Input.Intent.Kind,

                Name =
                    Clean(
                        payload.Input.Intent.Name,
                        120)
            }
        };
    }
        ...
        AtomicSharePayload payload)
    {
        ...
        var ac =
            payload.Recommendation.AssettoCorsa;
        ...
        sb.AppendLine(
            $"{payload.Input.Car.DisplayName} • {payload.Input.Pack.Name}");

        sb.AppendLine(
            $"{payload.Input.Hardware.Manufacturer} {payload.Input.Hardware.Model} • {payload.Input.Wheel.Model}");

        sb.AppendLine(
            $"Target: {payload.Input.Intent.Name}");

        sb.AppendLine(
            $"Created with ADT {payload.AtomicVersion} • {payload.CreatedUtc:u}");
        ...
        sb.AppendLine(
            $"Max Wheel Speed {a.MaximumWheelSpeedPct}% • Interpolation {a.Interpolation}");

        sb.AppendLine(
            $"Wheel Damper {a.WheelDamperPct}% • Friction {a.WheelFrictionPct}% • Natural Inertia {a.NaturalInertia}");

        sb.AppendLine(
            $"High-Speed Damping {a.HighSpeedDampingPct}% @ {a.HighSpeedTriggerKph} kph");

        sb.AppendLine(
            $"AC Gain {ac.GainPct}% • Filter {ac.FilterPct}% • Min Force {ac.MinimumForcePct}%");

        sb.AppendLine(
            $"Scores: Self-Steer {payload.Recommendation.SelfSteerScore}/100 • Stability {payload.Recommendation.StabilityScore}/100 • Detail {payload.Recommendation.DetailScore}/100");

        sb.AppendLine(
            $"Estimated peak wheel torque: {payload.Recommendation.EstimatedPeakWheelTorqueNm:0.0} Nm");
        ...
        sb.AppendLine(
            $"Front {Signed(b.FrontEndBite)} • Rear Grip {Signed(b.RearGrip)} • Self-Steer {Signed(b.SelfSteerSpeed)} • Transition {Signed(b.TransitionSpeed)}");
        ...
        sb.AppendLine(
            "Import safety: context is loaded and regenerated locally. The snapshot above is never applied directly to AZOM.");
        ...
        AtomicSharePayload payload)
    {
        ...
        {
            throw new InvalidDataException(
                "Share payload is missing.");
        }

        if (
            payload.Input is null ||
        ...
        {
            throw new InvalidDataException(
                "Share payload is missing required sections.");
        }
        ...
        {
            throw new InvalidDataException(
                "Share code creation time is missing.");
        }
        ...
        {
            throw new InvalidDataException(
                "Share code contains an unsupported grip level.");
        }

        if (!Enum.IsDefined(payload.Input.Intent.Kind))
        {
            throw new InvalidDataException(
                "Share code contains an unsupported drift target.");
        }

        if (!Enum.IsDefined(
                payload.Recommendation.Azom.OutputCurvePreset))
        {
            throw new InvalidDataException(
                "Share code contains an unsupported output-curve preset.");
        }
        ...
        RequireInt(
            a.GameFfbStrengthPct,
            0,
            100,
            "Game FFB");

        RequireInt(
            a.BaseTorqueOutputPct,
            50,
            100,
            "Base torque");

        RequireInt(
            a.MaximumWheelSpeedPct,
            0,
            200,
            "Maximum wheel speed");
        ...
        RequireInt(
            a.HighSpeedDampingPct,
            0,
            100,
            "High-speed damping");

        RequireInt(
            a.HighSpeedTriggerKph,
            0,
            400,
            "High-speed trigger");
        ...
        RequireRange(
            payload.Recommendation.EstimatedPeakWheelTorqueNm,
            0,
            100,
            "Estimated peak torque");

        RequireInt(
            payload.Recommendation.SelfSteerScore,
            0,
            100,
            "Self-steer score");

        RequireInt(
            payload.Recommendation.StabilityScore,
            0,
            100,
            "Stability score");

        RequireInt(
            payload.Recommendation.DetailScore,
            0,
            100,
            "Detail score");
        ...
        {
            throw new InvalidDataException(
                "Share code contains too many notes.");
        }
        ...
        string label)
    {
        ...
        {
            throw new InvalidDataException(
                $"{label} is outside the supported share-code range.");
        }
    }
